...
from myTool import compute_joint_loss, compute_seg_label_3, decode_segmap, validation
...
def main():
    ...
    try:
        shutil.rmtree('/data/u5876230/ete_wsss/pseudo/')
    except:
        pass
    try:
        shutil.rmtree('/data/u5876230/ete_wsss/heatmap/')
    except:
        pass
    try:
        shutil.rmtree('/data/u5876230/ete_wsss/seg_pred/')
    except:
        pass
    try:
        shutil.rmtree('/data/u5876230/ete_wsss/saliency_pseudo/')
    except:
        pass
    
    os.mkdir('/data/u5876230/ete_wsss/pseudo/')
    os.mkdir('/data/u5876230/ete_wsss/heatmap/')
    os.mkdir('/data/u5876230/ete_wsss/seg_pred/')
    os.mkdir('/data/u5876230/ete_wsss/saliency_pseudo/')
...
def train(gpu, args):
    ...
    for iter in range(max_step+1):
        ...
        if (optimizer.global_step-1) < args.cls_step * max_step:
            ...
            torch.distributed.barrier()
            model.zero_grad()
            x, seg, img_feature = model(img)
            # seg = model.module.forward_seg(img)
            ...
            for batch_index in range(b):
                ...
                cv2.imwrite('/data/u5876230/ete_wsss/seg_pred/{}_{}.png'.format(name, iter),
            ...
            if args.sal_loss:
                ...
                loss = celoss  + sal_loss + dloss +closs   #+ entropy_loss1
            else:
                loss =  celoss + dloss + closs #+ entropy_loss1
